...
for i, out_filename in enumerate(['pH7_I01_edited','pH7_I0_edited','pH72_I01_edited','pH72_I0_edited']):
    ...
    zeros_and_nans = (match_ids_comp['prediction_model.dG0'].isnull() | match_ids_comp['prediction_model.dG0'].isin([0]))
    tolerable_error = (match_ids_comp['dG0_std'] < 50)
    #non_crazy_values = (match_ids_comp['prediction_model.dG0'] < 900 & match_ids_comp['prediction_model.dG0'] > -900)
